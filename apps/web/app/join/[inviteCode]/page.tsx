      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg text-center max-w-sm w-full">
        ...
        {loggedIn ? (
          ...
          <div className="space-y-3">
            <Link
              href={`/auth/register?redirect=/join/${inviteCode}`}
            ...
            <Link
              ...
              className="w-full py-3 bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-200 font-medium rounded-xl border border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-600 transition-all flex items-center justify-center gap-2"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <p className="text-xs text-gray-400 dark:text-gray-500 mt-4">
          {loggedIn
            ...
            : "Create an account to join this league and start tracking your games."
          }
        </p>
      </div>
    </main>
